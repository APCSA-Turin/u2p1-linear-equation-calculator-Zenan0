...
public class LinearCalculatorRunner {
    public static void main(String[] args) {
        // LinearCalculator calc = new LinearCalculator("(1,3)", "(3,4)");
        // System.out.println(calc.getX1());
        // System.out.println(calc.getX2());
        // System.out.println(calc.getY1());
        // System.out.println(calc.getY2());
        // System.out.println(calc.distance());
        // System.out.println(calc.slope());
